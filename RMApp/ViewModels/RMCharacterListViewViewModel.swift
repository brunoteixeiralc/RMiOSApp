...
final class RMCharacterListViewViewModel: NSObject {
    ...
    private var apiInfo: RMGetsAllCharactersResponse.Info? = nil
    ...
    public func fetchCharacters() {
        RMService.shared.execute(.listCharactersRequests, expecting: RMGetsAllCharactersResponse.self) { [weak self] result in
            switch result {
    ...
    public func fetchAdditionalCharacters(url: URL) {
        ...
        RMService.shared.execute(request, expecting: RMGetsAllCharactersResponse.self) { [weak self] result in
...
extension RMCharacterListViewViewModel: UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        guard kind == UICollectionView.elementKindSectionFooter,
                ...
                shouldShowLoadMoreIndicator else {
           fatalError("Unsupported")
        }
